...
import com.resukisu.resukisu.ui.util.BOOT_PATCH_COMMAND
import com.resukisu.resukisu.ui.util.VENDOR_BOOT_RMVR_COMMAND
import com.resukisu.resukisu.ui.util.isVendorBootTarget
import com.resukisu.resukisu.ui.util.resolveBootImageKindForOutput
...
class KsuCliRepository(context: Context) {
    ...
    fun installBoot(
        ...
        if (useVendorBootRmvr && lkm != LkmSelection.KmiNone) {
            onStdout(context.getString(com.resukisu.resukisu.R.string.vendor_boot_rmvr_lkm_not_used))
        }
